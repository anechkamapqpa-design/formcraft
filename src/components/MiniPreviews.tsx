...
export const miniPreviewMap: Record<string, () => JSX.Element> = {
  "Minimal Portfolio": MiniMinimalPortfolio,
  "Dark Studio": MiniDarkStudio,
  "SaaS Startup": MiniSaaSStartup,
  "Creative Agency": MiniCreativeAgency,
  "Personal Brand": MiniPersonalBrand,
  "Product Showcase": MiniProductShowcase,
  "Startup Pitch": MiniStartupPitch,
  "Digital Art Gallery": MiniDigitalArtGallery,
  "Corporate Website": MiniCorporateWebsite,
  "Startup Animation": MiniStartupAnimation,
  "Marketplace Platform": MiniMarketplacePlatform,
  "Mobile App Landing": MiniMobileAppLanding,
  "Startup Community": MiniStartupCommunity,
  "Luxury Brand": MiniLuxuryBrand,
  "Event Landing": MiniEventLanding,
  "Education Platform": MiniEducationPlatform,
  "Creative Blog": MiniCreativeBlog,
  "Freelancer Landing": MiniFreelancerLanding,
  "Startup Dashboard": MiniStartupDashboard,
  "Architecture Studio": MiniArchitectureStudio,
  "Fitness Brand": MiniFitnessBrand,
  "Restaurant Website": MiniRestaurantWebsite,
  "AI Product Landing": MiniAIProductLanding,
  "Creative Startup": MiniCreativeStartup,
};
